...
//
// // append a group elelment for the scale legend
// var g = svg.append("g")
//     .attr("class", "key")
//     .attr("transform", "translate(0,40)");
//
// // add 9 rectangles to the g element for the scale legend  making sure
// // that start and end of threshold arrays have no undefined values
// g.selectAll("rect")
...
//
//     //create a color threshold scale for the map
